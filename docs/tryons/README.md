...
| FACE        | 8             | 50% (32/64)       | [FACE.md](./FACE.md) — FOUNDATION [detail](./FOUNDATION.md) ✅, BLUSH [detail](./BLUSH.md), CONCEALER [detail](./CONCEALER.md), HIGHLIGHTER [detail](./HIGHLIGHTER.md), CONTOUR [detail](./CONTOUR.md) |
| NAIL        | 5             | 0% (0/40)         | [NAIL.md](./NAIL.md)                                                                                                                                                                                   |
| SKIN        | 8             | 0% (0/64)         | [SKIN.md](./SKIN.md)                                                                                                                                                                                   |
| **Overall** | **43**        | **35% (120/344)** | —                                                                                                                                                                                                      |
...
2. **FACE** 🔄 in progress (FOUNDATION ✅ done 10/10, BLUSH/CONCEALER/HIGHLIGHTER/CONTOUR 🔄 built/pending real-device QA, 3 aur subcategories baaki) — same face-landmark engine reuse, thoda bada region set
