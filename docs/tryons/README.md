...
| FACE        | 8             | 59.4% (38/64)     | [FACE.md](./FACE.md) — FOUNDATION [detail](./FOUNDATION.md) ✅, BLUSH [detail](./BLUSH.md), CONCEALER [detail](./CONCEALER.md), HIGHLIGHTER [detail](./HIGHLIGHTER.md), CONTOUR [detail](./CONTOUR.md), BRONZER [detail](./BRONZER.md) |
| NAIL        | 5             | 0% (0/40)         | [NAIL.md](./NAIL.md)                                                                                                                                                                                                                   |
| SKIN        | 8             | 0% (0/64)         | [SKIN.md](./SKIN.md)                                                                                                                                                                                                                   |
| **Overall** | **43**        | **37% (126/344)** | —                                                                                                                                                                                                                                      |
...
2. **FACE** 🔄 in progress (FOUNDATION ✅ done 10/10, BLUSH/CONCEALER/HIGHLIGHTER/CONTOUR/BRONZER 🔄 built/pending real-device QA, 2 aur subcategories baaki) — same face-landmark engine reuse, thoda bada region set
