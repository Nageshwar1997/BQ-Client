...
| FACE        | 8             | 68.75% (44/64)    | [FACE.md](./FACE.md) — FOUNDATION [detail](./FOUNDATION.md) ✅, BLUSH [detail](./BLUSH.md), CONCEALER [detail](./CONCEALER.md), HIGHLIGHTER [detail](./HIGHLIGHTER.md), CONTOUR [detail](./CONTOUR.md), BRONZER [detail](./BRONZER.md), BBCREAM [detail](./BBCREAM.md) |
| NAIL        | 5             | 0% (0/40)         | [NAIL.md](./NAIL.md)                                                                                                                                                                                                                                                   |
| SKIN        | 8             | 0% (0/64)         | [SKIN.md](./SKIN.md)                                                                                                                                                                                                                                                   |
| **Overall** | **43**        | **38% (132/344)** | —                                                                                                                                                                                                                                                                      |
...
2. **FACE** 🔄 in progress (FOUNDATION ✅ done 10/10, BLUSH/CONCEALER/HIGHLIGHTER/CONTOUR/BRONZER/BBCREAM 🔄 built/pending real-device QA, 1 aur subcategory baaki) — same face-landmark engine reuse, thoda bada region set
