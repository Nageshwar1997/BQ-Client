...
| EYE         | 7             | 10.7% (6/56)      | [EYE.md](./EYE.md) — EYELINER [detail](./EYELINER.md)                                                                                                                                                                                                                                                              |
...
3. **EYE** 🔄 in progress (EYELINER ✅ built, first pattern-bearing finish - baaki 6 subcategories baaki) — precision-heavy (thin lines, lash detail), zyada QA chahiye
