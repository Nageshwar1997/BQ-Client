...
| EYE         | 7             | 21.4% (12/56)       | [EYE.md](./EYE.md) — EYELINER [detail](./EYELINER.md), KAJAL [detail](./KAJAL.md)                                                                                                                                                                                                                                  |
...
3. **EYE** 🔄 in progress (EYELINER + KAJAL ✅ built together, same shared primitive per this doc's own build order below - baaki 5 subcategories baaki) — precision-heavy (thin lines, lash detail), zyada QA chahiye
