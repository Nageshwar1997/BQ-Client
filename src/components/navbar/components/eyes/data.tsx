  ...
  subCategories: [
    {
      ...
      label: "Kohl",
      category: "kohl",
      path: `${basePath}/kohl_and_kajal/kohl`,
      icon: KohlIcon,
      description:
    ...
    },
    {
      ...
      label: "Kajal",
      category: "kajal",
      path: `${basePath}/kohl_and_kajal/kajal`,
      icon: KajalIcon,
      description:
    ...
    },
    {
      ...
      path: `${basePath}/kohl_and_kajal/smudge_proof_kajal`,
  ...
  subCategories: [
    {
      ...
      path: `${basePath}/mascaras/volumizing_mascara`,
    ...
    },
    {
      ...
      path: `${basePath}/mascaras/curl_lengthening_mascara`,
    ...
    },
    {
      ...
      path: `${basePath}/mascaras/waterproof_mascara`,
  ...
  subCategories: [
    {
      ...
      path: `${basePath}/eyeliners/liquid_eyeliner`,
    ...
    },
    {
      ...
      path: `${basePath}/eyeliners/gel_eyeliner`,
    ...
    },
    {
      ...
      path: `${basePath}/eyeliners/pen_eyeliner`,
  ...
  subCategories: [
    {
      ...
      path: `${basePath}/eyeshadow/eyeshadow_palette`,
    ...
    },
    {
      ...
      path: `${basePath}/eyeshadow/liquid_eyeshadow`,
    ...
    },
    {
      ...
      path: `${basePath}/eyeshadow/glitter_eyeshadow`,
  ...
  subCategories: [
    {
      ...
      path: `${basePath}/eyebrows/brow_definer`,
    ...
    },
    {
      ...
      path: `${basePath}/eyebrows/brow_pencil`,
      icon: BrowPencilIcon,
      description:
    ...
    },
    {
      ...
      label: "Brow Gel",
      category: "brow_gel",
      path: `${basePath}/eyebrows/brow_gel`,
      icon: BrowGelIcon,
      description:
  ...
  subCategories: [
    {
      ...
      label: "Eyelashes",
      category: "eyelashes",
      path: `${basePath}/eye_value_set/eyelashes`,
      icon: EyelashesIcon,
      description:
    ...
    },
    {
      ...
      path: `${basePath}/eye_value_set/eye_gift_set`,
      icon: EyeGiftSetIcon,
      description:
    ...
    },
    {
      ...
      label: "Eye Combo",
      category: "eye_combo",
      path: `${basePath}/eye_value_set/eye_combo`,
      icon: EyeComboIcon,
      description:
