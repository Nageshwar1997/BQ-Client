  ...
  subCategories: [
    {
      ...
      label: "Foundation",
      category: "foundation",
      path: `${basePath}/face_makeup/foundation`,
      icon: FoundationIcon,
      description:
    ...
    },
    {
      ...
      label: "BB Cream",
      category: "bb_cream",
      path: `${basePath}/face_makeup/bb_cream`,
      icon: BBCreamIcon,
      description:
    ...
    },
    {
      ...
      path: `${basePath}/face_makeup/compact_powder`,
    ...
    },
    {
      ...
      path: `${basePath}/face_makeup/loose_powder`,
    ...
    },
    {
      ...
      path: `${basePath}/face_makeup/banana_powder`,
    ...
    },
    {
      ...
      path: `${basePath}/face_makeup/spf_foundation`,
...
export const traditional_and_essentials: LevelTwoCategoryType = {
  ...
  path: `${basePath}/traditional_and_essentials`,
  subCategories: [
    {
      id: 1,
      level: 3,
      label: "Sindoor",
      category: "sindoor",
      path: `${basePath}/traditional_and_essentials/sindoor`,
      icon: SindoorIcon,
      description:
  ...
  subCategories: [
    {
      ...
      path: `${basePath}/cheeks_and_glow/highlighter`,
    ...
    },
    {
      ...
      path: `${basePath}/cheeks_and_glow/liquid_highlighter`,
    ...
    },
    {
      ...
      label: "Blush",
      category: "blush",
      path: `${basePath}/cheeks_and_glow/blush`,
      icon: BlushIcon,
      description:
    ...
    },
    {
      ...
      path: `${basePath}/cheeks_and_glow/cheek_stain`,
      icon: CheekStainIcon,
      description:
...
export const setting_and_finishing: LevelTwoCategoryType = {
  ...
  path: `${basePath}/setting_and_finishing`,
  subCategories: [
    {
      id: 1,
      level: 3,
      ...
      path: `${basePath}/setting_and_finishing/setting_spray`,
    ...
    },
    {
      ...
      label: "Compact",
      category: "compact",
      path: `${basePath}/setting_and_finishing/compact`,
      icon: CompactIcon,
      description:
    ...
    },
    {
      ...
      label: "Fixer",
      category: "fixer",
      path: `${basePath}/setting_and_finishing/fixer`,
      icon: FixerIcon,
      description:
...
export const foundations_by_finish: LevelTwoCategoryType = {
  ...
  path: `${basePath}/foundations_by_finish`,
  subCategories: [
    {
      id: 1,
      level: 3,
      ...
      path: `${basePath}/foundations_by_finish/liquid_foundation`,
    ...
    },
    {
      ...
      path: `${basePath}/foundations_by_finish/matte_foundation`,
    ...
    },
    {
      ...
      path: `${basePath}/foundations_by_finish/water_resistant_foundation`,
    ...
    },
    {
      ...
      path: `${basePath}/foundations_by_finish/high_coverage_foundation`,
    ...
    },
    {
      ...
      path: `${basePath}/foundations_by_finish/stick_foundation`,
...
export const foundations_by_skin_type: LevelTwoCategoryType = {
  ...
  path: `${basePath}/foundations_by_skin_type`,
  subCategories: [
    {
      id: 1,
      level: 3,
      ...
      path: `${basePath}/foundations_by_skin_type/best_for_dry_skin`,
    ...
    },
    {
      ...
      path: `${basePath}/foundations_by_skin_type/best_for_oily_skin`,
...
export const primers_and_removers: LevelTwoCategoryType = {
  ...
  path: `${basePath}/primers_and_removers`,
  subCategories: [
    {
      id: 1,
      level: 3,
      ...
      path: `${basePath}/primers_and_removers/makeup_remover`,
    ...
    },
    {
      ...
      label: "Primer",
      category: "primer",
      path: `${basePath}/primers_and_removers/primer`,
      icon: PrimerIcon,
      description:
...
export const bronzers_and_contours: LevelTwoCategoryType = {
  ...
  path: `${basePath}/bronzers_and_contours`,
  subCategories: [
    {
      id: 1,
      level: 3,
      label: "Bronzer",
      category: "bronzer",
      path: `${basePath}/bronzers_and_contours/bronzer`,
      icon: BronzerIcon,
      description:
    ...
    },
    {
      ...
      label: "Contour",
      category: "contour",
      path: `${basePath}/bronzers_and_contours/contour`,
      icon: ContourIcon,
      description:
...
export const concealers_and_correctors: LevelTwoCategoryType = {
  ...
  path: `${basePath}/concealers_and_correctors`,
  subCategories: [
    {
      id: 1,
      level: 3,
      ...
      path: `${basePath}/concealers_and_correctors/color_concealer`,
    ...
    },
    {
      ...
      path: `${basePath}/concealers_and_correctors/color_corrector`,
