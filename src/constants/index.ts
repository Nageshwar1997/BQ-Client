...
export const DEPARTMENTS = [
  {
    ...
    roles: [
      ...
      { title: "CEO (Chief Executive Officer)", value: "ceo", employees: [] },
      { title: "COO (Chief Operating Officer)", value: "coo", employees: [] },
      { title: "CFO (Chief Financial Officer)", value: "cfo", employees: [] },
      { title: "CMO (Chief Marketing Officer)", value: "cmo", employees: [] },
      { title: "CTO (Chief Technology Officer)", value: "cto", employees: [] },
      { title: "CPO (Chief Product Officer)", value: "cpo", employees: [] },
    ],
  },
  {
    ...
    roles: [
      {
        title: "Head of Product / VP of Product",
        value: "head_of_product_or_vp_of_product",
        employees: [],
      },
      { title: "Category Manager", value: "category_manager", employees: [] },
      { title: "Merchandiser", value: "merchandiser", employees: [] },
      {
  ...
  },
  {
    ...
    roles: [
      ...
      { title: "Backend Developer", value: "backend_developer", employees: [] },
      {
      ...
      { title: "UI/UX Designer", value: "ui-ux_designer", employees: [] },
    ],
  },
  {
  ...
  },
  {
    ...
    roles: [
      ...
      {
        title: "Account Manager / Client Success Manager",
        value: "account_manager_or_client_success_manager",
        employees: [],
      },
      {
        title: "Sales Executive / Associate",
        value: "sales_executive_or_associate",
        employees: [],
      },
      {
        title: "Customer Support / Customer Service Representative",
        value: "customer_support_or_representative",
        employees: [],
      },
      {
        title: "Chat / Email Support Specialist",
  ...
  },
  {
    ...
    roles: [
      {
        title: "Head of Operations / Supply Chain",
        value: "head_of_operations_or_supply_chain",
        employees: [],
      },
      {
        title: "Inventory Manager / Stock Controller",
        value: "inventory_manager_or_stock_controller",
        employees: [],
      },
      {
        title: "Warehouse Manager / Supervisor",
      ...
      {
        title: "Packaging / Fulfillment Staff",
  ...
  },
  {
    ...
    roles: [
      ...
      { title: "Data Analyst", value: "data_analyst", employees: [] },
      {
        title: "Business Intelligence (BI) Analyst",
        value: "business_intelligence_analyst",
        employees: [],
      },
      { title: "Data Scientist", value: "data_scientist", employees: [] },
      { title: "Marketing Analyst", value: "marketing_analyst", employees: [] },
    ],
  },
  {
    ...
    roles: [
      ...
      {
        title: "Cybersecurity Specialist / Engineer",
      ...
      { title: "Content Moderator", value: "content_moderator", employees: [] },
    ],
  },
];
