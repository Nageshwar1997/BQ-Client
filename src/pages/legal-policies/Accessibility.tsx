...
const ACCESSIBILITY_FEATURES = [
  ...
  },
  {
    ...
    description:
      'Status, errors, and actions are always paired with text or icons, not color alone.',
  },
] as const;
  ...
  return (
    <StaticPageLayout>
      <StaticPageHeader
        ...
        description="At Beautinique, we believe beauty should be inclusive. We're committed to making every part of our platform accessible, usable, and enjoyable for everyone, regardless of ability or the technology they use to browse."
        meta={
          <div className="flex flex-wrap items-center justify-center gap-2">
            <span className="border-primary/20 text-primary rounded-full border px-3 py-1 text-xs font-medium sm:text-sm">
              WCAG 2.1 Level AA
            </span>
            <LastUpdatedBadge label="Last reviewed" />
          </div>
        }
      />
      ...
      <StaticPageSection title="Conformance Status" className="gap-3">
        <p className="text-secondary text-sm leading-relaxed sm:text-base">
          The{' '}
          ...
          disabilities. It defines three levels of conformance: A, AA, and AAA. Beautinique is{' '}
          <span className="text-primary font-medium">partially conformant with WCAG 2.1 AA</span>,
          meaning most of the site meets this standard, and the sections that don&apos;t yet are
          listed openly under <span className="text-primary font-medium">Known Limitations</span>{' '}
          below.
        </p>
      </StaticPageSection>

      <StaticPageSection title="Features We Support">
        <InfoCardGrid items={ACCESSIBILITY_FEATURES} />
      </StaticPageSection>

      <StaticPageSection title="Browser & Assistive Technology Compatibility">
        <p className="text-secondary text-sm leading-relaxed sm:text-base">
      ...
      <StaticPageSection title="Keyboard Shortcuts">
      ...
      <StaticPageCTA
        ...
        description="If you encounter any accessibility barriers or have suggestions, we'd love to hear from you. We aim to respond within 2 business days."
        actions={<EmailUsAction />}
        footer={
          <div className="border-primary/10 flex items-start gap-2 border-t pt-4">
            <Icon
              icon="solar:clock-circle-linear"
              className="text-primary/50 mt-0.5 size-4 shrink-0"
            />
