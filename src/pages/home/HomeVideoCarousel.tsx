      ...
      <div className="h-full w-full">
        ...
        {['prev', 'next'].map((type, index) => (
          <button
            ...
            } bg-primary/50 hover:bg-primary hidden -translate-y-1/2 transform cursor-pointer rounded-full p-3 lg:group-hover:block`}
          >
            <Icon
              icon={
                type === 'prev' ? 'solar:alt-arrow-left-linear' : 'solar:alt-arrow-right-linear'
              }
            ...
            {videos.map((_, index) => (
              <div
                ...
                style={
                  index === currentIndex
                    ? {
                        background: `conic-gradient(rgb(var(--blue-crayola-c-rgb)) ${String(progress)}%, var(--silver-jet) ${String(progress)}%)`,
                        WebkitMask:
