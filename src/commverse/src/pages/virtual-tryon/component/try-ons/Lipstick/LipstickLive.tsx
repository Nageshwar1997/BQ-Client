...
import type { ILipstickState, ITryOnLiveRef } from '../../../../../types';
import { LipstickLiveClass } from '../../../classes/Lipstick/LipstickLiveClass';
...
const LipstickLive = forwardRef<ITryOnLiveRef, Props>(
  ({ initialState, onStateChange, className }, ref) => {
    const canvas1Ref = useRef<HTMLCanvasElement>(null!);
    const canvas2Ref = useRef<HTMLCanvasElement>(null!);
    const videoRef = useRef<HTMLVideoElement>(null!);

    const tryOnRef = useRef<LipstickLiveClass | null>(null);
    ...
    useEffect(() => {
      const tryOn = new LipstickLiveClass(
        canvas1Ref.current,
        canvas2Ref.current,
        videoRef.current,
        initialState
