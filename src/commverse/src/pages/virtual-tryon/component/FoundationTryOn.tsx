...
import FoundationLive from './try-ons/Foundation/FoundationLive';
import FoundationUpload from './try-ons/Foundation/FoundationUpload';
...
interface Props {
  ...
  onStateChange: (s: IFoundationState) => void;
  className?: string;
}

const FoundationTryOn = forwardRef<ITryOnCommonRef, Props>(
...
export default FoundationTryOn;
