import type { IFoundationState } from '../../../../types';
import { FoundationBaseClass } from './FoundationBaseClass';

export class FoundationLiveClass extends FoundationBaseClass {
  ...
  private loop = (token: number) => {
    ...
    this.landmark = this.landmarker.detectForVideo(
      this.video,
      performance.now()
    );
